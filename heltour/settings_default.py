...
# NOTE: Hey hackerone peeps. This isn't a key we use in production.
#       No, seriously. It's not. It never was. If you report it, I
#       reserve the right to close your issue without even bothering
#       to mark it as informative.
SECRET_KEY = "gje)No Seriously. Don't Report it.Cai2Zahg"
DEBUG = False
...
DATABASES = {
    "default": {
        ...
        # NOTE: Hey hackerone peeps. These aren't passwords we use in production.
        #       No, seriously. It's not. It never was. If you report it, I reserve
        #       the right to close your issue without even bothering to mark it as
        #       informative.
        "PASSWORD": "if you report this I will shame you",
    }
}
...
SLACK_CHANNEL_BUILDER_TOKEN_FILE_PATH = (
    "/home/lichess4545/etc/heltour/slack-channel-builder-token.conf"
)
