...
ZULIP_URL = 'https://lichess4545-test.zulipchat.com'
ZULIP_CONFIG = '/home/lichess4545/etc/heltour/zuliprc' # bot account for heltour
ZULIP_CONFIG_NOBOT = '/home/lichess4545/etc/heltour/zuliprc_nobot' # human account for heltour
ZULIP_LISTENING_BOT = 878065 # userid, presumably chesster
ZULIP_HELTOUR_BOT = 875701 # userid of heltour bot
ZULIP_ERROR_LOGGING = True # log some errors to zulip
ZULIP_ERROR_LOG = 'msg-forward>ERROR' # without the initial #, no spaces between channel and topic.
