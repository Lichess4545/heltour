...
LICHESS_OAUTH_ACCOUNT_URL = LICHESS_DOMAIN + 'api/account'
LICHESS_OAUTH_EMAIL_URL = LICHESS_DOMAIN + 'api/email'
LICHESS_OAUTH_AUTHORIZE_URL = LICHESS_DOMAIN + 'oauth'
LICHESS_OAUTH_TOKEN_URL = LICHESS_DOMAIN + 'api/token'
