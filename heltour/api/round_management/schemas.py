"""Pydantic DTOs and websocket message schemas for the round-management
domain. Field naming follows ``terms.md``: a Match is one game; a Team
Match is the parent of board pairings in team events.
"""
