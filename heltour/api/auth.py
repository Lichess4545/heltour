...
``User``, then exposes ``can_change_pairing`` per league — the single
permission gating the staff-only edit/presence surfaces on the pairings
page (see `heltour/tournament/views.py:721,723`).
