...
Used by the v1 HTTP routes (initial-page render) and by the pub/sub
signal layer (live updates). Sharing the construction here means the
WS payload is structurally identical to a fresh GET — the UI can treat
a streamed `match.update` exactly like a refetch of one row.
"""

from __future__ import annotations

from heltour.api.schemas import MatchDTO, TeamMatchDTO
