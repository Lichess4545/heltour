...
class SeasonTestCase(TestCase):
    ...
    def test_season_board_number_list(self):
        season = Season.objects.create(
            league=League.objects.all()[0], name="Test 2", rounds=2, boards=4
        )
...
class AlternateTestCase(TestCase):
    ...
    def test_alternate_update_board_number(self):
        ...
        AlternateBucket.objects.create(
            season=season, board_number=1, max_rating=None, min_rating=2000
        )
        AlternateBucket.objects.create(
            season=season, board_number=2, max_rating=2000, min_rating=1800
        )
        AlternateBucket.objects.create(
            season=season, board_number=3, max_rating=1800, min_rating=None
        )
    ...
    def test_priority_date(self):
        ...
        AlternateAssignment.objects.create(
            round=r, team=Team.objects.all()[0], board_number=1, player=sp.player
        )
...
class PlayerByeTestCase(TestCase):
    ...
    def test_playerbye_save_and_delete(self):
        ...
        bye = PlayerBye.objects.create(
            round=round1, player=sp.player, type="half-point-bye"
        )
    ...
    def test_playerbye_refresh_rank(self):
        ...
        bye1 = PlayerBye.objects.create(
            round=round1, player=sp1.player, type="half-point-bye"
        )
        bye2 = PlayerBye.objects.create(
            round=round1, player=sp2.player, type="full-point-bye"
        )
