...
alternate_needed = Signal(providing_args=['alternate', 'response_hours', 'accept_url', 'decline_url'])
alternate_spots_filled = Signal(providing_args=['alternate', 'response_hours'])
