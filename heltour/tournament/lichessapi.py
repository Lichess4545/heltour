...
def get_latest_game_metas(
    lichess_username, number, priority=0, max_retries=5, timeout=1800
):
    url = (
        "%s/lichessapi/api/games/user/%s?max=%s&ongoing=true&priority=%s&max_retries=%s&format=application/x-ndjson"
