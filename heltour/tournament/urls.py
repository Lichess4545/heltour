...
season_urlpatterns = [
    ...
    url(r'^request/(?P<req_type>\w+)/t/(?P<secret_token>\w+)/$', views.ModRequestView.as_view(), name='modrequest_with_token'),
    ...
    url(r'^availability/edit/(?P<secret_token>\w+)/$', views.AvailabilityView.as_view(), name='edit_availability_with_token'),
