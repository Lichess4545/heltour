...
season_urlpatterns = [
    ...
    path(
        "standings/section/<slug:section>/",
    ...
    path(
        "pairings/team/<int:team_number>/calendar.ics",
        views.ICalPairingsView.as_view(),
        name="pairings_by_team_icalendar",
    ),
    path(
        "round/<int:round_number>/pairings/",
        views.PairingsView.as_view(),
    ...
    path(
        "tv/json/",
        cache_control(no_cache=True)(views.TvJsonView.as_view()),
        name="tv_json",
    ),
    path(
        "document/<slug:document_tag>/", views.DocumentView.as_view(), name="document"
    ),
    path("request/<slug:req_type>/", views.ModRequestView.as_view(), name="modrequest"),
    path(
        "request/<slug:req_type>/success/",
        views.ModRequestSuccessView.as_view(),
        name="modrequest_success",
    ),
    path("nominate/", views.NominateView.as_view(), name="nominate"),
    path(
        "nominate/delete/<int:nomination_id>/",
        views.DeleteNominationView.as_view(),
    ...
    path(
        "board/<int:board_number>/scores/",
        views.BoardScoresView.as_view(),
        name="board_scores",
    ),
    path("alternates/", views.AlternatesView.as_view(), name="alternates"),
    path(
        "round/<int:round_number>/alternate/accept/",
        views.AlternateAcceptView.as_view(),
        name="alternate_accept",
    ),
    path(
        "round/<int:round_number>/alternate/decline/",
        views.AlternateDeclineView.as_view(),
...
league_urlpatterns = [
    ...
    path(
        "contact_success/", views.ContactSuccessView.as_view(), name="contact_success"
    ),
...
api_urlpatterns = [
    ...
    path(
        "get_league_moderators/",
        api.get_league_moderators,
        name="get_league_moderators",
    ),
...
urlpatterns = [
    ...
    path(
        "auth/lichess/login_failed/",
        views.LoginFailedView.as_view(),
        name="login_failed",
    ),
    path("comments/", include("django_comments.urls")),
    path("ckeditor/", include("ckeditor_uploader.urls")),
    path(
        "<slug:league_tag>/", include((league_urlpatterns, "tournament"), "by_league")
    ),
]
