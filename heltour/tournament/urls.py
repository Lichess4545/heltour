...
urlpatterns = [
    ...
    url(r'^api/find_pairing/player/(?P<player>\w+)/$', api.find_pairing_by_player, name='api_find_pairing_by_player'),
    url(r'^api/find_pairing/season/(?P<season_id>[0-9]+)/player/(?P<player>\w+)/$', api.find_pairing_by_season_player, name='find_pairing_by_season_player'),
    url(r'^api/find_pairing/white/(?P<white>\w+)/black/(?P<black>\w+)/$', api.find_pairing_by_white_black, name='api_find_pairing_by_white_black'),
    url(r'^api/find_pairing/season/(?P<season_id>[0-9]+)/white/(?P<white>\w+)/black/(?P<black>\w+)/$', api.find_pairing_by_season_white_black, name='api_find_pairing_by_season_white_black'),
