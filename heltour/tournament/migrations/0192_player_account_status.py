...
class Migration(migrations.Migration):
    def update_player_status(apps, schema_editor):
        ...
        Players.objects.filter(account_status__in=("engine", "booster")).update(
            account_status="tos_violation"
        )
    ...
    operations = [
        ...
        migrations.RunPython(
            update_player_status, reverse_code=migrations.RunPython.noop
        ),
    ]
