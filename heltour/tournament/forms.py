...
class RegistrationForm(forms.ModelForm):
    class Meta:
        ...
        labels = {
            ...
            'can_commit': _(u'Are you able to commit to 1 Long Time Control Game (45|45, urrently) of Classical Chess on Lichess.org per week?'),
        ...
        widgets = {
            'has_played_20_games': forms.RadioSelect(),
            'already_in_slack_group': forms.RadioSelect(),
            'can_commit': forms.RadioSelect(),
            'agreed_to_rules': forms.RadioSelect(),
