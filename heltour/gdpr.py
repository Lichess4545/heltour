...
AGREED_TO_TOS_LABEL = textwrap.dedent(
    """Do you agree to comply with the Lichess External Tournaments Terms of Service?"""
)
AGREED_TO_TOS_HELP_TEXT = mark_safe(
    ...
    <a href="/fwccc-qualifier1/document/privacy-policy/">Privacy Policy</a>
    (and justified in our
    <a href="/fwccc-qualifier1/document/terms-of-service/">Terms of Service</a>)
     """
    )
)

MISSING_CONSENT_MESSAGE = (
    "We require this consent for you to participate in our leagues"
)
