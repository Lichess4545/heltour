...
pg_dump --clean --no-owner --no-privileges --format=plain --host localhost heltour_lichess4545 --username heltour_lichess4545 --port 5433 >& $OF
bzip2 $OF
ln -sf $BZOF /home/lichess4545/backups/heltour-sql/hourly/latest.sql.bz2
/home/lichess4545/www/www.lichess4545.com/env/bin/python /home/lichess4545/www/www.lichess4545.com/current/sysadmin/backup.py
