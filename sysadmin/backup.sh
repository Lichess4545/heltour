...
/usr/lib/postgresql/9.6/bin/pg_dump --clean --no-owner --no-privileges --format=plain --host localhost heltour_lichess4545 --username heltour_lichess4545 --port 5433 >& $OF
bzip2 $OF
